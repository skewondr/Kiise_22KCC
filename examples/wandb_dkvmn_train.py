...
if __name__ == "__main__":
    ...
    train_args.add_argument("--model_name", type=str, default="dkvmn")
    ...
    model_args.add_argument("--dim_s", type=int, default=200)
    model_args.add_argument("--learning_rate", type=float, default=1e-3)
    model_args.add_argument("--size_m", type=int, default=50)
