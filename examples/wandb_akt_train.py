...
if __name__ == "__main__":
    ...
    train_args.add_argument("--model_name", type=str, default="akt") #
    ...
    model_args.add_argument("--d_ff", type=int, default=2048)
    model_args.add_argument("--num_attn_heads", type=int, default=4)
