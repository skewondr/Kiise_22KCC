...
if __name__ == "__main__":
    ...
    train_args.add_argument("--model_name", type=str, default="kqn")
    ...
    model_args.add_argument("--n_hidden", type=int, default=128)
    model_args.add_argument("--n_rnn_hidden", type=int, default=128)
    model_args.add_argument("--n_mlp_hidden", type=int, default=128)
    model_args.add_argument("--n_rnn_layers", type=int, default=1)
